...
void	ResponseMessage::setStartLine() {
	...
	this->start_line += data->status_code;
	this->start_line += " ";
	this->start_line += setStatusMessage(data->status_code); //this->data->status_code;
	return ;
}
...
std::string	ResponseMessage::getResponseMessage(void) {
	return (this->message);
}
